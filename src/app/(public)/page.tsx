      ...
      <section className="relative overflow-hidden border-y border-border/80 py-10 sm:py-12 lg:py-20">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-end">
          <div className="max-w-3xl">
            <p className="mb-6 flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.32em] text-primary">
              <span className="h-px w-10 bg-primary" />
              روزمرگی، با طعم بهتر
            </p>
            <h1 className="max-w-3xl text-4xl font-semibold leading-[1.1] tracking-[-0.04em] text-foreground sm:text-6xl lg:text-7xl">
              مکثی آرام،
              <br />
          ...
          <div className="glass-panel relative min-h-[18rem] overflow-hidden rounded-[1.4rem] p-6 lg:min-h-[25rem]">
            <div className="absolute inset-0 bg-[linear-gradient(135deg,transparent_20%,rgba(47,107,86,0.14),transparent_70%)]" />
            <div className="relative flex h-full flex-col justify-between gap-12">
              <div className="flex items-start justify-between">
                <span className="grid h-12 w-12 place-items-center rounded-[0.9rem] bg-primary text-primary-foreground shadow-[0_20px_34px_-18px_rgba(47,107,86,0.9)]">
              ...
              <div>
                ...
                <div className="mt-5 flex flex-wrap gap-2 text-xs text-muted-foreground">
                  ...
                  <span className="inline-flex items-center gap-1 rounded-full border border-border/80 bg-surface/80 px-2.5 py-1.5">
                    <Clock3 className="h-3.5 w-3.5 text-secondary" /> سرو سریع
                  </span>
                </div>
              </div>
            </div>
